...
class Rosary:
    ...
    def __init__(self,
        ...
        self.set_registry = {
            ...
            'cross_left': frozenset(self.cross[0:225]),
            'cross_right': frozenset(self.cross[225:448]),
            'cross_left_halfway_up': frozenset(self.cross[0:138]),
            'cross_right_halfway_up': frozenset(self.cross[311:448])
        }

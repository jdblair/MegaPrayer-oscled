...
from mp.effects import effect, bin, looper, sparkle, random_fill

class CrossIdle(effect.Effect):
    """
    ...
    def __init__(self, bead_set, color=_color.Color(), **kwargs):
        super().__init__(name="cross_idle", bead_set=bead_set, color=color, **kwargs)
        ...
        self.bin.add_effect_object(random_fill.RandomFill(bead_set, color=_color.Color(1, 1, 1)))
